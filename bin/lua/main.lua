...
Main.main = function() 
  ...
  while (_g < _g1) do _hx_do_first_1 = false;
    ...
    local randX = _G.math.random() * sign;
    local randY = _G.math.random() * sign;
    playdate.graphics.fillRect(realCenter.x + ((_G.math.cos(i) * radius) * randX), realCenter.y + ((_G.math.sin(i) * radius) * randY), 4 * randX, 4 * randX);
  end;
